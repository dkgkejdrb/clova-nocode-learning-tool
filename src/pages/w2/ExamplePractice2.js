  ...
  return (
    <>
      ...
      <div style={{ width: "100%", display: "flex", justifyContent: "center" }}>
        ...
        >
          <div style={{ marginLeft: 38, width: 350 }}>
            <div
              style={{
                fontSize: "1.1rem",
                fontWeight: 600,
          ...
          <div style={{ marginLeft: 80, width: 600 }}>
            <div
              style={{
                fontSize: "1.1rem",
                fontWeight: 600,
        ...
        >
          ...
          >
            ...
            <div style={{ width: 230, marginBottom: "20px", display: "flex" }}>
              ...
              <div className="right" style={{ display: "flex", alignItems: "center", paddingLeft: 10 }}  >
                  ...
                  style={{position: "relative"}}/>
                {
                  ...
                  :
                  <Image preview={false} width={500} src={Guide0} style={{ display: "none", position: "absolute", right: 520, borderRadius: 8, border: "1px solid #d9d9d9", zIndex: 1 }} />
                }
              </div>
            </div>
            ...
            <div style={{ width: 230, marginBottom: "10px", display: "flex" }}>
              ...
              <div className="right" style={{ display: "flex", alignItems: "center", paddingLeft: 10 }}>
                  ...
                  }}  style={{position: "relative"}}/>
                {
                  ...
                  ?
                  <Image preview={false} width={500} src={Guide1_revised} style={{ position: "absolute", top: -10, right: 520, borderRadius: 8, border: "1px solid #d9d9d9", zIndex: 1 }} />
                  :
                  <Image preview={false} width={500} src={Guide1_revised} style={{ display: "none", position: "absolute", right: 520, borderRadius: 8, border: "1px solid #d9d9d9", zIndex: 1 }} />
                }
              </div>
            </div>
            ...
            <div style={{ width: 230, marginBottom: "10px", display: "flex" }}>
              ...
              <div className="right" style={{ display: "flex", alignItems: "center", paddingLeft: 10 }}>
                ...
                style={{position: "relative"}}/>
                {
                  ...
                  ?
                  <Image preview={false} width={500} src={Guide2_revised} style={{ position: "absolute", top: -10, right: 520, borderRadius: 8, border: "1px solid #d9d9d9", zIndex: 1 }} />
                  :
                  <Image preview={false} width={500} src={Guide2_revised} style={{ display: "none", position: "absolute", right: 520, borderRadius: 8, border: "1px solid #d9d9d9", zIndex: 1 }} />
                }
              </div>
            </div>
            ...
            <div style={{ width: 230, marginBottom: "10px", display: "flex" }}>
              ...
              <div className="right" style={{ display: "flex", alignItems: "center", paddingLeft: 10 }}>
                  ...
                  style={{position: "relative"}}/>
                {
                  ...
                  ?
                  <Image preview={false} width={500} src={Guide3} style={{ position: "absolute", top: -10, right: 520, borderRadius: 8, border: "1px solid #d9d9d9", zIndex: 1 }} />
                  :
                  <Image preview={false} width={500} src={Guide3} style={{ display: "none", position: "absolute", right: 520, borderRadius: 8, border: "1px solid #d9d9d9", zIndex: 1 }} />
                }
              </div>
            </div>
            ...
            <div style={{ width: 230, marginBottom: "10px", display: "flex" }}>
              ...
              <div className="right" style={{ display: "flex", alignItems: "center", paddingLeft: 10 }}>
                ...
                style={{position: "relative"}}/>
                {
                  ...
                  :
                  <Image preview={false} width={500} src={Guide4} style={{ display: "none", position: "absolute", right: 520, borderRadius: 8, border: "1px solid #d9d9d9", zIndex: 1 }} />
                }
              </div>
            </div>
            ...
            <div style={{ width: 230, marginBottom: "10px", display: "flex" }}>
              ...
              <div className="right" style={{ display: "flex", alignItems: "center", paddingLeft: 10 }}>
                ...
                />
                {
                  ...
                  :
                  <Image preview={false} width={500} src={Guide5} style={{ display: "none", position: "absolute", right: 520, borderRadius: 8, border: "1px solid #d9d9d9", zIndex: 1 }} />
                }
              </div>
            </div>
            ...
            <div style={{ width: 230, marginBottom: "10px", display: "flex", position: "relative" }}>
              ...
              style={{ marginBottom: "10px", width: 210 }}>
                정지문자(Stop sequences)
              </div>
              <Space size={[0, 8]} wrap>
                <Space size={[0, 8]} wrap>
              ...
              <div className="right" style={{ display: "flex", alignItems: "center" }}>
                <QuestionCircleOutlined 
                  ...
                  :
                  <Image preview={false} width={500} src={Guide6} style={{ display: "none", position: "absolute", right: 505, borderRadius: 8, border: "1px solid #d9d9d9", zIndex: 1 }} />
                }
              </div>
            </div>
            ...
            <div style={{ width: 230, marginBottom: "10px", display: "flex" }}>
              ...
              <div className="right" style={{ display: "flex", alignItems: "center", paddingLeft: 10 }}>
                  ...
                  :
                  <Image preview={false} width={500} src={Guide7} style={{ display: "none", position: "absolute", right: 520, borderRadius: 8, border: "1px solid #d9d9d9", zIndex: 1 }} />
                }
              </div>
            </div>
            ...
            <div style={{ width: 230, marginBottom: "10px", display: "flex" }}>
              ...
              <div className="right" style={{ display: "flex", alignItems: "center", paddingLeft: 10 }}>
                  ...
                  :
                  <Image preview={false} width={500} src={Guide8} style={{ display: "none", position: "absolute", right: 520, borderRadius: 8, border: "1px solid #d9d9d9", zIndex: 1 }} />
                }
              </div>
            </div>
          </div>
...
export default ExamplePractice2;