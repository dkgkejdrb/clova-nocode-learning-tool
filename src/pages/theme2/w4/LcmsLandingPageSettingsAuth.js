...
const practices = [
  {
    storyKorPage1: testData.storyKor.step1,
    storyEngPage1: testData.storyEng.step1,
  },
  {
    storyKorPage1: testData.storyKor.step1,
    storyEngPage1: testData.storyEng.step1,
...
const LcmsLandingPageSettingsAuth = () => {
  ...
  // 미리보기 클릭 시, 이동하는 URL
  // const pageURL = "http://localhost:3000/#/teamstorybook/landing/1/1";
  const pageURL =
    "https://clova-practice.codingbiz.creverse.com/#/teamstorybook/landing/1/1";
        ...
        <>
          ...
          >
            <div className="hompageSettings">
              ...
              >
                <div style={{ marginLeft: 7, zIndex: 1, position: "relative" }}>
                  조 설정
                  <div
                    style={{
                      position: "absolute",
                ...
                {/* <div style={{ marginTop: 80, marginLeft: 7, zIndex: 1, position: "relative" }}>
                  영어 스토리북 설정
                  <div
                    style={{
                      position: "absolute",
              ...
              >
                ...
                >
                  <span>협동 학습 데이터</span>
                  <span>
                    조회 & 선택<span style={{ color: "red" }}>*</span>
                  </span>
                </div>
                <div
                  style={{
                        ...
                        <Space direction="vertical">
                          {practices.map((data) => (
                            <Radio
                              ...
                              value={data.id}
                              style={{ fontSize: 20 }}
                            ><div>{`${data.storyKorPage1.slice(0, 35) + '...'}`}</div>
                            <div>{`${data.storyEngPage1.slice(0, 70) + '...'}`}</div>
                          </Radio>
                          ))}
                        </Space>
                      </Radio.Group>
              ...
              >
                ...
                <div style={{ width: 720 }}>
                  ...
                  <div style={{ fontSize: 14, color: "rgba(0, 0, 0, 0.45)" }}>
                    (필수) 파일형식: jpg, jpeg, png / 너비: 768px / 높이: 512px
                  </div>
                </div>
              </div>
              ...
              >
                ...
                <div style={{ width: 720 }}>
                  ...
                  <div style={{ fontSize: 14, color: "rgba(0, 0, 0, 0.45)" }}>
                    (필수) 파일형식: jpg, jpeg, png / 너비: 384px / 높이: 640px
                  </div>
                </div>
              </div>
              ...
              >
                <div style={{ width: 180, fontWeight: 600 }}>
                  <span>
                    서평 - 코멘트
                    <div>
                      <span style={{ fontSize: 12 }}>(선택)</span>
                    </div>
                  </span>
                </div>
                <div style={{ width: 720 }}>
