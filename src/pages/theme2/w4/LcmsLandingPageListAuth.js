...
const testData = [
    {
      ...
      }, pageURL: "https://clova-practice.codingbiz.creverse.com/#/teamstorybook/landing/1/1", title: 'Deok-bae Kim, a worker in a different world', description: '일반인 김덕배의 좌충우돌 판타지 모험 이야기. 평범한 일상 속 햄스터 챗바퀴 돌리듯 휩쓸려 살기만하는 일상 속에서 당신은 모험을 꿈꾸는가? 여기에 바로 용사 김덕배의 이야기가 있다.', nickName: "김작가호랭작가"
    },
    {
      character: {
        name: "persona.png",
                  ...
                  renderItem={(item, index) => (
                    <List.Item>
                      <List.Item.Meta
                        ...
                        title={<a href={item.pageURL} target='_blank' rel="noopener noreferrer">[{index+1}조 - {item.title}] [{item.nickName}]</a>}
