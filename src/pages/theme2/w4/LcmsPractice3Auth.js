      ...
      >
        ...
        // ) : (
          ...
          >
            ...
            <Row
              index={1}
              textAreaEngHandler={textAreaEngHandler}
              storyEngText={storyEngText}
              beforeUpload_1={beforeUpload_1}
              storyImg_1={storyImg_1}
              storyImgUrl_1={storyImgUrl_1}
            />
            <Row
              index={2}
              textAreaEngHandler={textAreaEngHandler}
              storyEngText={storyEngText}
              beforeUpload_2={beforeUpload_2}
              storyImg_2={storyImg_2}
              storyImgUrl_2={storyImgUrl_2}
            />
            <Row
              index={3}
              textAreaEngHandler={textAreaEngHandler}
              storyEngText={storyEngText}
              beforeUpload_3={beforeUpload_3}
              storyImg_3={storyImg_3}
              storyImgUrl_3={storyImgUrl_3}
            />
            ...
            <Row
              ...
              textAreaEngHandler={textAreaEngHandler}
              storyEngText={storyEngText}
              beforeUpload_4={beforeUpload_4}
              storyImg_4={storyImg_4}
              storyImgUrl_4={storyImgUrl_4}
            />
            <Row
              index={5}
              textAreaEngHandler={textAreaEngHandler}
              storyEngText={storyEngText}
              beforeUpload_5={beforeUpload_5}
              storyImg_5={storyImg_5}
              storyImgUrl_5={storyImgUrl_5}
            />
            <Row
              index={6}
              textAreaEngHandler={textAreaEngHandler}
              storyEngText={storyEngText}
              beforeUpload_6={beforeUpload_6}
              storyImg_6={storyImg_6}
              storyImgUrl_6={storyImgUrl_6}
            />
            <Row
              index={7}
              textAreaEngHandler={textAreaEngHandler}
              storyEngText={storyEngText}
              beforeUpload_7={beforeUpload_7}
              storyImg_7={storyImg_7}
              storyImgUrl_7={storyImgUrl_7}
            />
            <Row
              index={8}
              textAreaEngHandler={textAreaEngHandler}
              storyEngText={storyEngText}
              beforeUpload_8={beforeUpload_8}
              storyImg_8={storyImg_8}
              storyImgUrl_8={storyImgUrl_8}
            />
            <Row
              index={9}
              textAreaEngHandler={textAreaEngHandler}
              storyEngText={storyEngText}
              beforeUpload_9={beforeUpload_9}
              storyImg_9={storyImg_9}
              storyImgUrl_9={storyImgUrl_9}
            />
            <Row
              index={10}
              textAreaEngHandler={textAreaEngHandler}
              storyEngText={storyEngText}
              beforeUpload_10={beforeUpload_10}
              storyImg_10={storyImg_10}
              storyImgUrl_10={storyImgUrl_10}
            />
            <Row
              index={11}
              textAreaEngHandler={textAreaEngHandler}
              storyEngText={storyEngText}
              beforeUpload_11={beforeUpload_11}
              storyImg_11={storyImg_11}
              storyImgUrl_11={storyImgUrl_11}
            />
            <Row
              index={12}
              textAreaEngHandler={textAreaEngHandler}
              storyEngText={storyEngText}
              beforeUpload_12={beforeUpload_12}
              storyImg_12={storyImg_12}
              storyImgUrl_12={storyImgUrl_12}
            />
          </div>
        // )
        }
...
export default LcmsPractice3Auth;