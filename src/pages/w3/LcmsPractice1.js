    ...
    <div
      style={{
        ...
        <div
          ...
          <Button 
            onClick={showModal} icon={<UploadOutlined />} style={{ fontSize: 12, marginLeft: 225 }}>불러오기</Button>
          <>
          ...
          <input
            ...
            multiple
          ></input>
          <Button onClick={downloadJsonFile} icon={<DownloadOutlined />} style={{ fontSize: 12, marginLeft: 5 }}>저장하기</Button>
          <Button
            type='primary'
            onClick={onSubmit}
            loading={loading}
        ...
        <div 
          className='console' 
          style={{ width: "100%", height: "120px", backgroundColor: "#1e232e", marginLeft: 10, paddingTop: "10px", position: "relative"}}>
            {loading ? (
              <div
                style={{
                  width: 580,
          ...
          files.map((file, index)=>{
            ...
            return(
              <div
                ...
                <div className={index} style={{ fontSize: 20, fontWeight: "bold" }}>
                  {
                    file.title.length < 1
                ...
                <p className={index} style={{ fontSize: 15}}>
                  {
                    file.name.length > 11
